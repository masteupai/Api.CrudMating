...
if not exists (select * from sysobjects where name = 'TBSERVICOPRODUTOS' and xtype='U')
create table TBSERVICOPRODUTOS(
SERVICOPRODUTOID INT IDENTITY,
PRODUTOID INT,
SERVICOID INT,
QUANTIDADE INT,
CONSTRAINT TBPRODUTOSERVICO_PK_PRODUTOSERVICOID PRIMARY KEY (SERVICOPRODUTOID),
...
if not exists (select * from sysobjects where name = 'TBSERVICOFUNCIONARIOS' and xtype='U')
create table TBSERVICOFUNCIONARIOS(
SERVICOFUNCIONARIOID INT IDENTITY,
FUNCIONARIOID INT,
SERVICOID INT,
COMISSAO DECIMAL (8,2),
CONSTRAINT TBFUNCIONARIOSERVICO_PK_FUNCIONARIOSERVICOID PRIMARY KEY (SERVICOFUNCIONARIOID),
